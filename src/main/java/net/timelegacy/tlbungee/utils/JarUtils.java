...
public class JarUtils {
    ...
    private boolean RUNNING_FROM_JAR = false;
    ...
    public boolean extractFromJar(final String fileName,
    ...
    private final void copyInputStream(final InputStream in,
    ...
    public URL getJarUrl(final File file) throws IOException {
