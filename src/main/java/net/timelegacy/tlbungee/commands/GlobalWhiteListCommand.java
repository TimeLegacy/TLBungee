      ...
      if (r.getPriority() >= 9) {
        ...
        if (args.length == 0) {
          MessageUtils.sendMessage(
              ...
              false);
          MessageUtils.helpMenu(p, "/wlist <on/enable>", "Enable the Whitelist");
          MessageUtils.helpMenu(p, "/wlist <off/disable>", "Disable the Whitelist");
          MessageUtils.helpMenu(p, "/wlist kick", "Kick all non-whitelisted players");
          return;
        }
        ...
        if (args.length == 1) {
          ...
          if (third.equalsIgnoreCase("on") || third.equalsIgnoreCase("enable")) {
            ...
            MessageUtils.sendMessage(
                sender, MessageUtils.SUCCESS_COLOR + "Whitelist enabled.", true);
            MessageUtils.sendMessage(
                sender,
                MessageUtils.MAIN_COLOR
                    + "Whitelist Status: "
            ...
            MessageUtils.sendMessage(
                sender, MessageUtils.ERROR_COLOR + "Whitelist disabled.", true);
            MessageUtils.sendMessage(
                sender,
                MessageUtils.MAIN_COLOR
                    + "Whitelist Status: "
        ...
        MessageUtils.sendMessage(
            sender, "&fWhitelist Status: " + (plugin.whitelist ? "&aEnabled" : "&cDisabled"), true);
      } else {
